...
def dict_to_tf_example(data,
  ...
  """
  img_path = os.path.join(image_subdirectory, data['filename']+'.jpeg')
...
# Create trainval.txt list for data set splitting
def create_trainval_txt(image_dir, annotations_dir):
  dirList=os.listdir(image_dir)
  f = open(os.path.join(annotations_dir, 'trainval.txt'), 'w')
...
def main(_):
  ...
  create_trainval_txt(image_dir, annotations_dir)
